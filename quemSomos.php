...
<html lang="en">
  ...
  <section>
    <div class="container">
      <div class="row" style="margin-top:50px;">
        ...
        <div class="col-lg-4">
          <h4> Nefrologia é</h4>
          <p>a área da Medicina que se dedica aos cuidados das doenças dos rins. Apesar de ser uma especialidade complexa, uma grande parte das doenças renais são assintomáticas, ou seja, os pacientes não sentem nada até que a doença esteja em um estágio mais complicado e com maiores complicações. 
 
          A Sociedade Brasileira de Nefrologia recomenda consultar o seu nefrologista, mesmo sem sintomas nas seguintes condições clínicas:
          <ul class="lista-diferenciais rins-quemSomos-responsive">
            <li>Portadores de Diabetes Mellitus</li>
            <li>Portadores de Hipertensão Arterial Sistêmica</li>
            <li>Uso crônico de medicações e tratamento de doenças crônicas (por exemplo, câncer ou HIV)</li>
            <li>Obesidade</li>
      ...
      <div class="row">
        <div class="col-lg-6"></div>
        <div class="col-lg-4">
          <h4>Os nefrologistas da RENALE: Nefrologia, Diálise e Transplante renal</h4>
          <p>possuem destacada formação nas melhores universidades do país e experiência comprovada nos cenários de atuação local. </p>
        </div>
        <div class="col-lg-2"></div>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <h4>Diferencias</h4>
                <ul class="lista-diferenciais rins-quemSomos-responsive">
                  <li>Presença dos médicos plantonistas próximos ao paciente</li>
                  <li>Ausência do reuso dos materiais</li>
                  <li>Capilares de uso único</li>
                  <li>Tratamento de água em duplo passo</li>
                  <li>Equipamentos novos e modernos</li>
                  <li>Lanches individualizados e seguidos com nutricionistas</li>
                  <li>Ambiente humanizado</li>
                  <li>Equipe multidisciplinar presente e atuante</li>
                </ul>
  ...
  <section>
    <div class="container-fluid">
          ...
          <div class="col-lg-2 col-md-2 thumb"></div>
          <div class="col-lg-8 col-md-8 col-12 thumb">

                <div class="row">
                  <div class="col-lg-4 col-md-4 col-12 thumb">
                      <a class="thumbnail" href="#" data-image-id="" data-toggle="modal" data-title=""
                        data-image="img/fotos/clinica/entrada.JPG"
                         data-target="#image-gallery">

                          <img class="img-thumbnail"
                               src="img/fotos/clinica/entrada.JPG"
  ...
  <section id="equipe">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-2"></div>
        <div class="col-lg-10"> <h3>Nossa Equipe</h3> </div>
      </div>
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="row text-center">
            <div class="col-lg-4 medico">
              <div class="foto-med">
                <img src="img/fotos/pessoas/p1.png" alt="" class="img-fluid ExibirLightBox" style="margin:10px 0px;">
                <h4>Felipe Guedes</h4>
                <p>Nefrologista</p>
              </div>
              <div class="card perfil-med" >
                <div class="card-body">
                  <img src="img/fotos/pessoas/p1.png" alt="" class="img-fluid ExibirLightBox" style="margin:10px 0px;">

                  <h5 class="card-title">Felipe Leite Guedes (CRM 5867)</h5>
                  <!-- <p class="card-text">With supporting text below as a natural lead-in to additional content.</p> -->
                  <ul class="text-left perfil-card">
                    <li>Médico nefrologista pela Universidade de São Paulo – Faculdade de Medicina de Ribeirão Preto</li>
                    <li>Coordenador do Serviço de Nefrologia Clínica e da Hemodiálise do Hospital Universitário Onofre Lopes</li>
                    <li>Professor da Universidade Potiguar (UnP)</li>
                    <li>Nefrologista do Hospital Mons. Walfredo Gurgel.</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 medico">
              <div class="foto-med">
                <img src="img/fotos/pessoas/p2.png" alt="" class="img-fluid" style="margin:10px 0px;">
                <h4>Raquel Martins</h4>
                <p>Nefrologista</p>
              </div>
              <div class="card perfil-med" >
                <div class="card-body">
                  <img src="img/fotos/pessoas/p2.png" alt="" class="img-fluid" style="margin:10px 0px;">
                  <h5 class="card-title">Raquel Martins e Quirino (CRM 3413)</h5>
                  <!-- <p class="card-text">With supporting text below as a natural lead-in to additional content.</p> -->
                  <ul class="text-left perfil-card">
                    <li>Médica nefrologista pela Universidade de São Paulo (SP)</li>
                    <li>Nefrologista das equipes de Transplante do Hospital Universitário Onofre Lopes e do Hospital do Coração de Natal</li>
                    <li>Nefrologista do Hospital Estadual Ruy Pereira</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 medico">
              <div class="foto-med">
                <img src="img/fotos/pessoas/p3.png" alt="" class="img-fluid" style="margin:10px 0px;">
                <h4>Kellen Micheline</h4>
                <p>Nefrologista</p>
              </div>
              <div class="card perfil-med" >
                <div class="card-body">
                  ...
                  <h5 class="card-title">Kellen Micheline Alves Henrique Costa (CRM 3841)</h5>
                  <!-- <p class="card-text">With supporting text below as a natural lead-in to additional content.</p> -->
                  <ul class="text-left perfil-card">
                    <li>Médica nefrologista pela Universidade de São Paulo - Faculdade de
Medicina de Ribeirão Preto</li>
                    <li>Coordenadora do Serviço de Transplante Renal do Hospital
Universitário Onofre Lopes e do serviço de Transplante Renal do
Hospital do Coração de Natal</li>
                    <li>Nefrologista do Hospital Santa Catarina</li>
                  </ul>
                </div>
              </div>
            </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
          <div class="row text-center">
            <div class="col-lg-4 medico">
              <div class="foto-med">
                <img src="img/fotos/pessoas/p4.png" alt="" class="img-fluid" style="margin:10px 0px;">
                <h4>Rogeria Noga</h4>
                <p>Nefrologista</p>
              </div>
              <div class="card perfil-med" >
                <div class="card-body">
                  ...
                  <h5 class="card-title">Rogeria Noga de Medeiros Nunes (CRM 4889)</h5>
                  <!-- <p class="card-text">With supporting text below as a natural lead-in to additional content.</p> -->
                  <ul class="text-left perfil-card">
                    <li>Médica nefrologista pelo Hospital Evangélico de Curitiba (PR)</li>
                    <li>Nefrologista do Hospital Deoclécio Marques Lucena (SESAP-RN)</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 medico">
              <div class="foto-med">
                <img src="img/fotos/pessoas/p5.png" alt="" class="img-fluid" style="margin:10px 0px;">
                <h4>Flavio Ribeiro</h4>
                <p>Nefrologista</p>
              </div>
              <div class="card perfil-med" >
                <div class="card-body">
                  ...
                  <h5 class="card-title">Flavio Ribeiro Dantas Aguiar (CRM 4703)</h5>
                  <!-- <p class="card-text">With supporting textc below as a natural lead-in to additional content.</p> -->
                  <ul class="text-left perfil-card">
                    <li>Médico nefrologista pela Faculdade de Medicina de São José do Rio
Preto (FAMERP/SP)</li>
                    <li>Professor da Universidade Potiguar</li>
            ...
            <div class="col-lg-4 medico">
              <div class="foto-med">
                <img src="img/fotos/pessoas/p6.png" alt="" class="img-fluid" style="margin:10px 0px;">
                <h4>Charmy Cleyton </h4>
                <p>Nefrologista</p>
              </div>
              <div class="card perfil-med" >
                <div class="card-body">
                  ...
                  <h5 class="card-title">Charmy Cleyton Fernandes de Araujo (CRM 4543)</h5>
                  <!-- <p class="card-text">With supporting text below as a natural lead-in to additional content.</p> -->
                  <ul class="text-left perfil-card">
                    <li>médico nefrologista pelo IAMSPE (São Paulo)</li>
                    <li>Atua como hospitalista, intensivista e nefrologista em hospitais
particulares de Natal-RN</li>
                  </ul>
                </div>
              </div>
            </div>
   ...
   <div class="container-fluid">
     <div class="row">
       ...
       <div class="col-lg-2 col-12  text-center">
         ...
         <br>
         <br>
         <p>Dedicados ao cuidado de vidas.</p>
       </div>
