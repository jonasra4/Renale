...
<html lang="en">
  ...
  <body id="tratamentos">
    ...
    <section id="tela-tratamentos">
      <div class="container-fluid w-100 h-100 ">
        <div class="row align-items-center h-100">
          <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center">
            <h2>CONHEÇA NOSSA HEMODIÁLISE</h2>
          </div>
        </div>
      </div>
    </section>

    <section id="intro-tratamentos" class="back-padrao">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-3">
            <h3>Hemodiálise é </h3>
            <p>o processo de substituição do rim insuficiente em estágios avançados por um processo de trocas de substâncias que ocorre em uma máquina. É um tratamento crônico, que para alguns pacientes será realizado até o momento do transplante renal. Na RENALE: Nefrologia, Diálise e Transplante Renal a idéia é de humanizar ao máximo este tratamento. Sendo construído um ambiente agradável, em que os pacientes sintam-se na extensão de seus lares, com humanidade, aconchego, conforto e segurança. Conheça nossos diferenciais e nossa sala de diálise: 
            </p>
          </div>
          <div class="col-lg-2"></div>
    ...
    <section class="back-padrao" id="tratamentos-section">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-2 col-md-2"></div>
          <div class="col-lg-10 col-md-10 col-sm-10">
            <h3>Diferenciais da RENALE</h3>
          </div>
        </div>
        <div class="row espacamento-tratamentos align-items-center">
          <div class="col-lg-2"></div>
          <div class="col-lg-4 text-center espacamento-icones">
            <img src="img/icones/neufrologia.png" class="img-fluid icones-tratamentos" alt="">
          </div>
          <div class="col-lg-4">
            <ul>
        ...
        <div class="row espacamento-tratamentos align-items-center">
          ...
          <div class="col-lg-4">
            <ul>
              ...
              <li>Equipe de enfermagem com experiência</li>
              <li>Lanches individualizados e seguidos com nutricionista</li>
