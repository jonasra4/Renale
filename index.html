...
<html lang="en">
  ...
  <body id="inicio">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav ml-auto text-uppercase">
            ...
            <li class="nav-item dropdown ">
              <a class="nav-link dropdown-toggle " href="index.html" id="dropdown01" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">PT</a>
              <div class="dropdown-menu ddd" aria-labelledby="dropdown01">
                <a class="dropdown-item  ddd" href="tratamentos.html">ENG</a>
              </div>
            </li>
      ...
      <div class="container-fluid w-100 h-100 ">
        <div class="row align-items-center h-100">
          <div class="col-lg-12 col-md-12 col-sm-12 col-12 text-center">
            <h2>DEDICADOS AO CUIDADO DE VIDAS</h2>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="forma-section">
      ...
      <div class="container-fluid padding-forma" >
        <div class="row">
          <div class="col-lg-2 col-md-2"></div>
          <div class="col-lg-5 col-md-5 col-12">
            <img src="img/fotos/circulos.png" alt="" class="img-fluid">
          </div>

          <div class="col-md-4 col-lg-3 col-12">
            <h3>Nefrologia, Diálise e Transplante Renal</h3>
            <p>A RENALE é uma clínica especializada no tratamento dos pacientes portadores de doenças renais. Realiza atendimento multiprofissional em ambulatórios, que contemplam a prevenção e o tratamento das doenças renais, o preparo pré-transplante renal e o seguimento do paciente pós-transplante renal. Também possui uma sala de hemodiálise diferenciada para atendimento de pacientes particulares e convênios.</p>
          </div>
          <div class="col-2"></div>
        </div>
    ...
    <section >
      ...
      <div class="container-fluid" id="rins-intro">
        <div class="row space787padding" >
          <div class="col-lg-6 col-md-6"></div>
          <div class="col-lg-4 col-md-4 col-12">
            <h4 style="margin-top:130px;">MISSÃO</h4>
      ...
      <div class="container-fluid">
        <div class="row" >
          ...
          <div class="col-lg-10 col-md-10 col-12">
            <h3 class="margin-tp-150">BLOG</h3>
          </div>
        </div>
        <div class="row">
         ...
         <div class="col-lg-8">
           <div class="row">
             <div class="col-md-4 col-lg-4 col-sm-4 col-12">
               <div class="card">
                 <img class="card-img-top" src="img/noticias/card1.png" alt="Card image cap">
                 <div class="card-body">
                   <h5 class="card-title">Card title</h5>
                   <p class="card-text">deixei assim msm, pq de todo jeito vai ter que mudar</p>
                 </div>
               </div>
             </div>
             <div class="col-md-4 col-lg-4 col-sm-4 col-12">
            ...
            <div class="col-lg-8">
                    ...
                    for($x=0; $x<$album_count; $x++){
                        ...
                        echo "<div class='col-md-8'>";
                            $id_0 = isset($obj['data'][0]['id']) ? $obj['data'][0]['id'] : "";
                            $link_0 = isset($obj['data'][0]['link']) ? $obj['data'][0]['link'] : "";
                            $capa_0 = isset($obj['data'][0]['cover_photo']['id']) ? $obj['data'][0]['cover_photo']['id'] : "";
                            $name_0 = isset($obj['data'][0]['name']) ? $obj['data'][0]['name'] : "";
                            $capa_nome_0 = isset($obj['data'][0]['cover_photo']['name']) ? $obj['data'][0]['cover_photo']['name'] : "";
                            
                            $album_link_0 = "album.php?album_id={$id_0}&album_name={$name_0}";
                            
                            echo "<div id='Modal_0' class='modal'>";
                                echo "<div class='modal-content'>";
                                    echo "<div class='modal-header'>";
                                        echo "<h3>";
                                            echo "<a class='card-title' style='color:#363636' href='{$album_link_0}'>{$name_0}</a>";
                                        echo "</h3>";
                                        echo "<span class='close_0'>&times;</span>";
                                    echo "</div>";
                                    echo "<div class='modal-body'>";
                                        echo "<div class='row'>";
                                            echo "<div class='col-md-4 col-12'>";
                                                echo "<img class='card-img-top img-fluid shadow bg-white rounded' 
                                                      style='border-bottom-right-radius: 5px; border-bottom-left-radius: 5px; width: 100%; padding: 1px;'
                                                      src='https://graph.facebook.com/v2.3/{$capa_0}/picture?access_token={$access_token}' alt=''>";
                                            echo "</div>";
                    ...
                    echo "</div>";
                        ...
                        // Second
                        echo "<div class='col-md-8'>";
                            $link_1 = isset($obj['data'][1]['link']) ? $obj['data'][1]['link'] : "";
                            $capa_1 = isset($obj['data'][1]['cover_photo']['id']) ? $obj['data'][1]['cover_photo']['id'] : "";
                            $id_1 = isset($obj['data'][1]['id']) ? $obj['data'][1]['id'] : "";
                            $name_1 = isset($obj['data'][1]['name']) ? $obj['data'][1]['name'] : "";
                            $capa_nome_1 = isset($obj['data'][1]['cover_photo']['name']) ? $obj['data'][1]['cover_photo']['name'] : "";
                            
                            $album_link_1 = "album.php?album_id={$id_1}&album_name={$name_1}";
                            
                            echo "<div id='Modal_1' class='modal'>";
                                echo "<div class='modal-content'>";
                                    echo "<div class='modal-header'>";
                                        echo "<h3>";
                                            echo "<a class='card-title' style='color:#363636' href='{$album_link_1}'>{$name_1}</a>";
                                        echo "</h3>";
                                        echo "<span class='close_1'>&times;</span>";
                                    echo "</div>";
                                    echo "<div class='modal-body'>";
                                        echo "<div class='row'>";
                                            echo "<div class='col-md-4 col-12'>";
                                                echo "<img class='card-img-top img-fluid shadow bg-white rounded' 
                                                      style='border-bottom-right-radius: 5px; border-bottom-left-radius: 5px; width: 100%; padding: 1px;'
                                                      src='https://graph.facebook.com/v2.3/{$capa_1}/picture?access_token={$access_token}' alt=''>";
                                            echo "</div>";
                                            echo "<div class='col-md-8 col-12'>";
                                                echo "<p class='card-text'>";
                                                    echo "<div style='overflow-y: auto;'>";
                        ...
                        // Third
                        echo "<div class='col-md-8'>";
                            $link_2 = isset($obj['data'][2]['link']) ? $obj['data'][2]['link'] : "";
                            $capa_2 = isset($obj['data'][2]['cover_photo']['id']) ? $obj['data'][2]['cover_photo']['id'] : "";
                            $id_2 = isset($obj['data'][2]['id']) ? $obj['data'][2]['id'] : "";
                            $name_2 = isset($obj['data'][2]['name']) ? $obj['data'][2]['name'] : "";
                            $capa_nome_2 = isset($obj['data'][2]['cover_photo']['name']) ? $obj['data'][2]['cover_photo']['name'] : "";
                            
                            $album_link_2 = "album.php?album_id={$id_2}&album_name={$name_2}";
                            
                            echo "<div id='Modal_2' class='modal'>";
                                echo "<div class='modal-content'>";
                                    echo "<div class='modal-header'>";
                                        echo "<h3>";
                                            echo "<a class='card-title' style='color:#363636' href='{$album_link_2}'>{$name_2}</a>";
                                        echo "</h3>";
                                        echo "<span class='close_2'>&times;</span>";
                                    echo "</div>";
                                    echo "<div class='modal-body'>";
                                        echo "<div class='row'>";
                                            echo "<div class='col-md-4 col-12'>";
                                                echo "<img class='card-img-top img-fluid shadow bg-white rounded' 
                                                      style='border-bottom-right-radius: 5px; border-bottom-left-radius: 5px; width: 100%; padding: 1px;'
                                                      src='https://graph.facebook.com/v2.3/{$capa_2}/picture?access_token={$access_token}' alt=''>";
                                            echo "</div>";
                                            echo "<div class='col-md-8 col-12'>";
                                                echo "<p class='card-text'>";
                                                    echo "<div style='overflow-y: auto;'>";
